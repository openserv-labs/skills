...
| `openserv-workflow-architect`    | Transform a loose idea into a deployment-ready multi-agent workflow prompt with production-tested platform knowledge and domain recipes |
